namespace Derick
{
    partial class FrmEmpleados
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlMostrarEmpleadosForm = new Panel();
            ...
            pnlAccesosRapido = new Panel();
            lblAceesosRapido = new Label();
            pnlBuscarEmpleado = new Panel();
            btnBuscarEmpleado = new Button();
            lbldescriBuscar = new Label();
            lblBuscarEmpleado = new Label();
            picBuscarEmpleado = new PictureBox();
            pnldepa = new Panel();
            btndepa = new Button();
            lbldescriDepa = new Label();
            lblVerDepartamentos = new Label();
            picDepartamentos = new PictureBox();
            pnlNuevoEmpleado = new Panel();
            btnNuevoEmpleado = new Button();
            lblDescriNuevo = new Label();
            lblNuevoEmpleado = new Label();
            picNuevoEmpleado = new PictureBox();
            pnlReportes = new Panel();
            btnReportes = new Button();
            lblDescriReportes = new Label();
            lblReportes = new Label();
            picReportes = new PictureBox();
            pnlNuevosMes = new Panel();
            pnlNuevos = new Panel();
            lblContrataciones = new Label();
            numNuevos = new Label();
            lblNuevosMes = new Label();
            picNuevosMes = new PictureBox();
            pnlBordeVentas = new Panel();
            pnlEmpleadosActivos = new Panel();
            pnlActi = new Panel();
            lblEmpleActivos = new Label();
            numEmpleadosActivos = new Label();
            lblEmpleadosActivos = new Label();
            picEmpleadosActivos = new PictureBox();
            pnlBordeSucur = new Panel();
            pnlDepartamentos = new Panel();
            pnlBordeEmple = new Panel();
            pnlDepar = new Panel();
            lblDeparCreados = new Label();
            numDepar = new Label();
            LblDepartamentos = new Label();
            picDepart = new PictureBox();
            pnlTotalEmpleados = new Panel();
            pnlBordePro = new Panel();
            pnlTotal = new Panel();
            lblEmpleadosRegistrados = new Label();
            NumTotalEmpleados = new Label();
            lblTotalEmpleados = new Label();
            picTotalEmpleados = new PictureBox();
            pnlBienvenidaEmpleado = new Panel();
            lblDescripcion = new Label();
            lblEmpleados = new Label();
            pnlMostrarEmpleadosForm.SuspendLayout();
            pnlActividadReciente.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridViewEmpleados).BeginInit();
            pnlAccesosRapido.SuspendLayout();
            pnlBuscarEmpleado.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picBuscarEmpleado).BeginInit();
            pnldepa.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picDepartamentos).BeginInit();
            pnlNuevoEmpleado.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picNuevoEmpleado).BeginInit();
            pnlReportes.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picReportes).BeginInit();
            pnlNuevosMes.SuspendLayout();
            pnlNuevos.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picNuevosMes).BeginInit();
            pnlEmpleadosActivos.SuspendLayout();
            pnlActi.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picEmpleadosActivos).BeginInit();
            pnlDepartamentos.SuspendLayout();
            pnlDepar.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picDepart).BeginInit();
            pnlTotalEmpleados.SuspendLayout();
            pnlTotal.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)picTotalEmpleados).BeginInit();
            pnlBienvenidaEmpleado.SuspendLayout();
            SuspendLayout();
            // 
            // pnlMostrarEmpleadosForm
            // 
            ...
            pnlMostrarEmpleadosForm.Size = new Size(1371, 868);
            ...
            lblListado.Location = new Point(23, 729);
            ...
            dataGridViewEmpleados.Location = new Point(23, 767);
            ...
            dataGridViewEmpleados.Size = new Size(1326, 95);
            ...
            // pnlAccesosRapido
            // 
            pnlAccesosRapido.BackColor = Color.White;
            pnlAccesosRapido.Controls.Add(lblAceesosRapido);
            pnlAccesosRapido.Controls.Add(pnlBuscarEmpleado);
            ...
            lblAceesosRapido.Location = new Point(24, 11);
            ...
            // pnlBuscarEmpleado
            // 
            pnlBuscarEmpleado.BackColor = Color.FromArgb(244, 246, 249);
            pnlBuscarEmpleado.Controls.Add(btnBuscarEmpleado);
            ...
            pnlBuscarEmpleado.Location = new Point(175, 47);
            pnlBuscarEmpleado.Margin = new Padding(3, 4, 3, 4);
            pnlBuscarEmpleado.Name = "pnlBuscarEmpleado";
            pnlBuscarEmpleado.Size = new Size(143, 264);
            pnlBuscarEmpleado.TabIndex = 5;
            // 
            // btnBuscarEmpleado
            // 
            btnBuscarEmpleado.BackColor = Color.FromArgb(0, 176, 80);
            ...
            btnBuscarEmpleado.Location = new Point(0, 221);
            ...
            lbldescriBuscar.Location = new Point(13, 125);
            lbldescriBuscar.Name = "lbldescriBuscar";
            lbldescriBuscar.Size = new Size(128, 77);
            ...
            lblBuscarEmpleado.Location = new Point(9, 91);
            ...
            // pnldepa
            // 
            pnldepa.BackColor = Color.FromArgb(244, 246, 249);
            pnldepa.Controls.Add(btndepa);
            pnldepa.Controls.Add(lbldescriDepa);
            pnldepa.Controls.Add(lblVerDepartamentos);
            pnldepa.Controls.Add(picDepartamentos);
            pnldepa.Location = new Point(325, 47);
            pnldepa.Margin = new Padding(3, 4, 3, 4);
            pnldepa.Name = "pnldepa";
            pnldepa.Size = new Size(143, 264);
            pnldepa.TabIndex = 4;
            // 
            // btndepa
            // 
            btndepa.BackColor = Color.FromArgb(112, 34, 246);
            ...
            btndepa.Location = new Point(0, 220);
            ...
            lbldescriDepa.Location = new Point(15, 125);
            lbldescriDepa.Name = "lbldescriDepa";
            lbldescriDepa.Size = new Size(119, 61);
            ...
            lblVerDepartamentos.Location = new Point(15, 92);
            ...
            // pnlNuevoEmpleado
            // 
            pnlNuevoEmpleado.BackColor = Color.FromArgb(244, 246, 249);
            pnlNuevoEmpleado.Controls.Add(btnNuevoEmpleado);
            ...
            pnlNuevoEmpleado.Location = new Point(24, 47);
            pnlNuevoEmpleado.Margin = new Padding(3, 4, 3, 4);
            pnlNuevoEmpleado.Name = "pnlNuevoEmpleado";
            pnlNuevoEmpleado.Size = new Size(143, 264);
            pnlNuevoEmpleado.TabIndex = 1;
            // 
            // btnNuevoEmpleado
            // 
            btnNuevoEmpleado.BackColor = Color.FromArgb(0, 102, 255);
            ...
            btnNuevoEmpleado.Location = new Point(0, 220);
            ...
            lblDescriNuevo.Location = new Point(6, 124);
            lblDescriNuevo.Name = "lblDescriNuevo";
            lblDescriNuevo.Size = new Size(134, 75);
            ...
            lblNuevoEmpleado.Location = new Point(8, 91);
            ...
            lblDescriReportes.Location = new Point(16, 124);
            lblDescriReportes.Name = "lblDescriReportes";
            lblDescriReportes.Size = new Size(123, 59);
            ...
            lblReportes.Location = new Point(30, 88);
            ...
            picReportes.Location = new Point(30, 8);
            picReportes.Margin = new Padding(3, 4, 3, 4);
            picReportes.Name = "picReportes";
            picReportes.Size = new Size(80, 76);
            ...
            pnlNuevosMes.Location = new Point(1031, 211);
            ...
            // pnlNuevos
            // 
            pnlNuevos.BackColor = Color.White;
            pnlNuevos.Controls.Add(lblContrataciones);
            ...
            pnlEmpleadosActivos.Location = new Point(357, 211);
            ...
            // pnlActi
            // 
            pnlActi.BackColor = Color.White;
            pnlActi.Controls.Add(lblEmpleActivos);
            ...
            pnlDepartamentos.Location = new Point(697, 211);
            ...
            pnlDepar.Controls.Add(lblDeparCreados);
            ...
            pnlTotalEmpleados.Location = new Point(23, 211);
            ...
            pnlTotal.Controls.Add(lblEmpleadosRegistrados);
            ...
            lblDescripcion.Location = new Point(48, 89);
            ...
            lblEmpleados.Location = new Point(57, 37);
            lblEmpleados.Name = "lblEmpleados";
            lblEmpleados.Size = new Size(172, 36);
            ...
            pnlAccesosRapido.ResumeLayout(false);
            pnlAccesosRapido.PerformLayout();
            pnlBuscarEmpleado.ResumeLayout(false);
            pnlBuscarEmpleado.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picBuscarEmpleado).EndInit();
            pnldepa.ResumeLayout(false);
            pnldepa.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picDepartamentos).EndInit();
            pnlNuevoEmpleado.ResumeLayout(false);
            pnlNuevoEmpleado.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picNuevoEmpleado).EndInit();
            pnlReportes.ResumeLayout(false);
            pnlReportes.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picReportes).EndInit();
            pnlNuevosMes.ResumeLayout(false);
            pnlNuevos.ResumeLayout(false);
            pnlNuevos.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picNuevosMes).EndInit();
            pnlEmpleadosActivos.ResumeLayout(false);
            pnlActi.ResumeLayout(false);
            pnlActi.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picEmpleadosActivos).EndInit();
            pnlDepartamentos.ResumeLayout(false);
            pnlDepar.ResumeLayout(false);
            pnlDepar.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picDepart).EndInit();
            pnlTotalEmpleados.ResumeLayout(false);
            pnlTotal.ResumeLayout(false);
            pnlTotal.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)picTotalEmpleados).EndInit();
            pnlBienvenidaEmpleado.ResumeLayout(false);
            pnlBienvenidaEmpleado.PerformLayout();
            ResumeLayout(false);
        }

        #endregion

        private Panel pnlMostrarEmpleadosForm;
        private Panel pnlBordeEmple;
        private Panel pnlActividadReciente;
        private Button btnVerTodo;
        private Label lblActividadRe;
        private Panel pnlAccesosRapido;
        private Label lblAceesosRapido;
        private Panel pnlBuscarEmpleado;
        private Button btnBuscarEmpleado;
        private Label lbldescriBuscar;
        private Label lblBuscarEmpleado;
        private PictureBox picBuscarEmpleado;
        private Panel pnldepa;
        private Button btndepa;
        private Label lbldescriDepa;
        private Label lblVerDepartamentos;
        private PictureBox picDepartamentos;
        private Panel pnlNuevoEmpleado;
        private Button btnNuevoEmpleado;
        private Label lblDescriNuevo;
        private Label lblNuevoEmpleado;
        private PictureBox picNuevoEmpleado;
        private Panel pnlReportes;
        private Button btnReportes;
        private Label lblDescriReportes;
        private Label lblReportes;
        private PictureBox picReportes;
        private Panel pnlNuevosMes;
        private Panel pnlNuevos;
        private Label lblContrataciones;
        private Label numNuevos;
        private Label lblNuevosMes;
        private PictureBox picNuevosMes;
        private Panel pnlBordeVentas;
        private Panel pnlDepartamentos;
        private Panel pnlDepar;
        private Label lblDeparCreados;
        private Label numDepar;
        private Label LblDepartamentos;
        private PictureBox picDepart;
        private Panel pnlEmpleadosActivos;
        private Panel pnlActi;
        private Label lblEmpleActivos;
        private Label numEmpleadosActivos;
        private Label lblEmpleadosActivos;
        private PictureBox picEmpleadosActivos;
        private Panel pnlBordeSucur;
        private Panel pnlTotalEmpleados;
        private Panel pnlBordePro;
        private Panel pnlTotal;
        private Label lblEmpleadosRegistrados;
        private Label NumTotalEmpleados;
        private Label lblTotalEmpleados;
        private PictureBox picTotalEmpleados;
